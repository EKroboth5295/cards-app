...
import "@eck5295/my-card/src/my-card.js";
  ...
  render() {
    return html`
      <main>
        ...
        <my-card header="Mario Card" details="This card represents Mario, an iconic video game character"><h1 slot="Header">Testing Slot</h1></my-card>
